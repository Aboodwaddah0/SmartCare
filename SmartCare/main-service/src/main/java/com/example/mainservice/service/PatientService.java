...
import com.example.mainservice.exception.ResourceAlreadyExistsException;
import com.example.mainservice.exception.ResourceNotFoundException;
import com.example.mainservice.repository.PatientRepository;
...
public class PatientService {
	...
	public List<Patient> getPatientByName(String name) {
		return patientRepository.findByUser_FullNameContainingIgnoreCase(name);
	}
}
