    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, GatewayAuthenticationFilter gatewayAuthenticationFilter) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v2/prescriptions").hasRole("DOCTOR")
                .requestMatchers("/api/v2/prescriptions/*").hasRole("DOCTOR")
                .requestMatchers("/api/v2/prescriptions/patient/**").hasAnyRole("PATIENT", "DOCTOR")
                .requestMatchers("/api/v2/medical-history").hasRole("DOCTOR")
                .requestMatchers("/api/v2/medical-history/*").hasRole("DOCTOR")
                .requestMatchers("/api/v2/medical-history/patient/**").hasAnyRole("PATIENT", "DOCTOR", "ADMIN")
