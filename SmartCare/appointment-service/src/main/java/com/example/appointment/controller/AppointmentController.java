...
public class AppointmentController {
	...
	public ResponseEntity<List<AppointmentDto.AppointmentResponse>> getAppointmentsForDoctor(
			@PathVariable Long doctorId,
			@RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date) {
		return ResponseEntity.ok(appointmentService.getAllAppointments(doctorId, date));
	}
	...
	@PostMapping
	public ResponseEntity<ApiResponse> bookAppointment(@RequestBody AppointmentDto.BookingRequest request) {
